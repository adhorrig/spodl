...
1) Spotify client id and secret. (Retrieve at: https://developer.spotify.com/)

2) Spotify account name and playlist ID. (Playlist ID is the alphanumeric string following /playlist/)

2) Youtube API Key. (Retrieve at: https://console.developers.google.com)

3) Youtube-dl installed on your machine. (Retrieve at: https://rg3.github.io/youtube-dl/download.html)
